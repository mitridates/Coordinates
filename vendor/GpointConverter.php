...
class GpointConverter
{
	...
	/**
	 * @var integer Equatorial Radius
	 */
	private $a;

	/**
	 * @var float  Square of eccentricity
	 */
	private $eccSquared;
	...
	public function setEllipsoid($name)
	{
		switch ($name) {
			...
			case 'International':
            case 'ED50':
                $this->a = 6378388;$this->eccSquared = 0.00672267;break; // International Ellipsoid
            case 'WGS 84':
			...
			case 'ETRS89': // Same as EUREF89 
				...
				break;
			default:
				throw new \InvalidArgumentException('No ellipsoid data associated with unknown datum: '.$name);
		}
	}
